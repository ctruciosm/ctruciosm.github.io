...
meta() %>%
  meta_description(
    "CIA (Causal Inference and Analytics) é um grupo de estudos que reune aluno(a)s da FACC/UFRJ interessados em métodos quantitativos e análise de dados. Discutimos tópicos relacionados com o Software R, Statistical/Machine Learnig, Econometria, Marketing Analytics, People Analytics, Python, Inferência Causal, etc…."
  ) %>% 
