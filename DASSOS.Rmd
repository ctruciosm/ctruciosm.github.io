...
- Para participar, envie um email a <carlos.trucios _at_ facc _dot_ ufrj _dot_ br>, substitua _at_ por `@` e _dot_ por `.`
...
- Após o curso de _R_, começaremos a discutir tópicos selecionados com métodos quantitativos. 
